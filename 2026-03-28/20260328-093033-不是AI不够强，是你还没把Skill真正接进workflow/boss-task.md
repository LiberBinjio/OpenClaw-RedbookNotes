...
4. 已复核现有 Boss 留痕与当前角色要求：`Boss/BOSS-CYCLE-20260328-085709.md`、`.role-sessions/BOSS.md`、`.role-sessions/Topic/TOPIC.md`。当前发现历史包路径存在漂移风险，`.role-sessions/BOSS.md` 仍指向 `20260328-072139`，`.role-sessions/Topic/TOPIC.md` 仍停留在 `20260314-153824`，本轮必须统一收口到新的归档包。
...
7. 已确认本轮 archive package 必须统一为：`2026-03-28 / 20260328-093033+AI技能别再只换模型，先把工作流接起来 / material files`。
...
- 统一归档日期：`2026-03-28`。
- 统一归档包：`2026-03-28 / 20260328-093033+AI技能别再只换模型，先把工作流接起来 / material files`。
...
- 必须把 `date`、`timestamp`、`archive_title`、`archive_package` 全量更新到本轮：`2026-03-28`、`20260328-093033`、`AI技能别再只换模型，先把工作流接起来`，不得继续沿用 `.role-sessions/BOSS.md` 的 `20260328-072139` 或 `.role-sessions/Topic/TOPIC.md` 的 `20260314-153824`。
...
6. **来源限制说明**
   - 当前能确认的主要仍是 Newrank 主站、`voice.newrank.cn` 与前序 Boss 留痕中的标题/摘要级线索，不是 `https://www.newrank.cn/search/trend/skill` 深层详情页本身。
...
- 必须核验 Topic / Draft / Cover / Review 的 archive timestamp 与 archive package 是否统一到 `20260328-093033`。
...
- `date` 层：`2026-03-28`。
- `timestamp+中文标题` 层：`20260328-093033+AI技能别再只换模型，先把工作流接起来`。
...
- 当前次级风险是 archive package 漂移：本轮所有下游都必须统一切到 `20260328-093033`，不能继续沿用 `.role-sessions/BOSS.md` 的 `20260328-072139` 或 `.role-sessions/Topic/TOPIC.md` 的 `20260314-153824`。
...
- 实际改动：新增 `Boss/BOSS-CYCLE-20260328-093033.md`
- 发布动作：未执行
