@ALL
归档路径建议：2026-04-05 / 20260405-091107+AI技能开始拼稳定交付真正拉开差距的是谁能把Skill接成workflow / material files
...
- 归档要求：所有下游产物统一对齐到 `2026-04-05 / 20260405-091107+AI技能开始拼稳定交付真正拉开差距的是谁能把Skill接成workflow / material files`。
...
- 本轮主选题统一为：`AI 技能开始拼稳定交付，真正拉开差距的是谁能把 Skill 接成 workflow`。
...
- Topic 归档字段必须统一到：
  - `date`: `2026-04-05`
  - `timestamp`: `20260405-091107`
  - `archive_title`: `AI技能开始拼稳定交付真正拉开差距的是谁能把Skill接成workflow`
  - `archive_package`: `2026-04-05 / 20260405-091107+AI技能开始拼稳定交付真正拉开差距的是谁能把Skill接成workflow / material files`
...
- 标题优先方向：
  1. AI 技能开始拼稳定交付了，真正拉开差距的是 workflow
...
- Draft 归档字段必须统一到 `20260405-091107`，不得沿用旧时间戳。
- 不得公开发布，不得写成自动发布指令。
...
- Cover 归档字段必须统一到 `20260405-091107`。
...
- 检查 Topic / Draft / Cover / Review 的 archive timestamp 与 archive package 是否统一到 `20260405-091107`。
- 检查最终产物是否仅用于预览、复审与手动发布，不自动公开发布。
- 如果下游仍沿用 `20260405-080836`、`20260405-073728`、`20260405-052327`、`20260405-034733` 等旧归档包，必须优先指出并要求统一修正。
...
- 下游角色以本文件与 `.role-sessions/Topic/TOPIC.md` 为准继续产出；如有冲突，以本轮时间戳 `20260405-091107` 与本文件来源边界为准统一收口。
