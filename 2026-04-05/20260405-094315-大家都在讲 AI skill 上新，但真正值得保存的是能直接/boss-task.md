@ALL
归档路径建议：2026-04-05 / 20260405-094315+AI技能开始卷落地了真正拉开差距的是谁能把Skill接进工作流 / material files
...
- 归档要求：所有下游产物统一对齐到 `2026-04-05 / 20260405-094315+AI技能开始卷落地了真正拉开差距的是谁能把Skill接进工作流 / material files`。
...
- 在上述边界下，本轮只能使用 `.role-sessions/Topic/TOPIC.md` 已整理的 Newrank 邻近公开标题/摘要级线索；不得把这些线索包装成 `search/trend/skill` 详情页原始事实。
...
- Draft 归档字段必须统一到 `20260405-094315`，不得沿用旧时间戳。
...
- Cover 归档字段必须统一到 `20260405-094315`。
...
- 检查 Topic / Draft / Cover / Review 的 archive timestamp 与 archive package 是否统一到 `20260405-094315`。
- 检查最终产物是否仅用于预览、复审与手动发布，不自动公开发布。
- 如果下游仍沿用 `20260405-031655`、`20260405-091107`、`20260405-080836`、`20260405-052327`、`20260405-034733` 等旧归档包，必须优先指出并要求统一修正。
...
- 下游角色以本文件与 `.role-sessions/Topic/TOPIC.md` 为准继续产出；如有冲突，以本轮时间戳 `20260405-094315` 与本文件来源边界为准统一收口。
